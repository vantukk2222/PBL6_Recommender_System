    ...
    return (
        <div>
            ...
            <div className="flex items-center mb-2">
                ...
                <p className="ms-1 text-lg font-medium text-gray-500 dark:text-gray-600">4.95</p>
                <p className="ms-1 text-lg font-medium text-gray-500 dark:text-gray-600">out of</p>
                <p className="ms-1 text-lg font-medium text-gray-500 dark:text-gray-600">5</p>
                </div>
            </div>
            <div className='flex'>
                <p className="ms-1 text-lg font-semibold text-gray-500 dark:text-gray-600">Total: </p>
